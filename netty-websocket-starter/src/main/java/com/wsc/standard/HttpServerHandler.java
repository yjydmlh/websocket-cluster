package com.wsc.standard;

import com.wsc.pojo.PojoEndpointServer;
import com.wsc.support.WsPathMatcher;
...
class HttpServerHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
    ...
    private static final ByteBuf FAVICON_BYTE_BUF;
    ...
    static {
        FAVICON_BYTE_BUF = buildStaticRes("/favicon.ico");
    ...
    private void handleHttpRequest(ChannelHandlerContext ctx, FullHttpRequest req) {
        ...
        if (!ObjectUtils.isEmpty(pojoEndpointServer.getHost()) && !"0.0.0.0".equals(pojoEndpointServer.getHost()) && !pojoEndpointServer.getHost().equals(host.split(":")[0])) {
            if (forbiddenByteBuf != null) {
                res = new DefaultFullHttpResponse(HTTP_1_1, FORBIDDEN, forbiddenByteBuf.retainedDuplicate());
            } else {
                res = new DefaultFullHttpResponse(HTTP_1_1, FORBIDDEN);
        ...
        if ("/favicon.ico".equals(path)) {
            if (FAVICON_BYTE_BUF != null) {
                res = new DefaultFullHttpResponse(HTTP_1_1, OK, FAVICON_BYTE_BUF.retainedDuplicate());
            } else {
